...
type PromoCodesClient interface {
	...
	DeletePromoCode(ctx context.Context, in *DeletePromoCodesRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *promoCodesClient) DeletePromoCode(ctx context.Context, in *DeletePromoCodesRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
type PromoCodesServer interface {
	...
	DeletePromoCode(context.Context, *DeletePromoCodesRequest) (*empty.Empty, error)
...
func (UnimplementedPromoCodesServer) DeletePromoCode(context.Context, *DeletePromoCodesRequest) (*empty.Empty, error) {
