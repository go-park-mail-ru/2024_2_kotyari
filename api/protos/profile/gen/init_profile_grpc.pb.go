...
type ProfileClient interface {
	...
	UpdateProfileData(ctx context.Context, in *UpdateProfileDataRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	UpdateProfileAvatar(ctx context.Context, in *UpdateAvatarRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *profileClient) UpdateProfileData(ctx context.Context, in *UpdateProfileDataRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *profileClient) UpdateProfileAvatar(ctx context.Context, in *UpdateAvatarRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func (c *profileClient) ChangePassword(ctx context.Context, in *ChangePasswordRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
type ProfileServer interface {
	...
	UpdateProfileData(context.Context, *UpdateProfileDataRequest) (*emptypb.Empty, error)
	UpdateProfileAvatar(context.Context, *UpdateAvatarRequest) (*emptypb.Empty, error)
...
func (UnimplementedProfileServer) UpdateProfileData(context.Context, *UpdateProfileDataRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateProfileData not implemented")
}
func (UnimplementedProfileServer) UpdateProfileAvatar(context.Context, *UpdateAvatarRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateProfileAvatar not implemented")
}
func (UnimplementedProfileServer) ChangePassword(context.Context, *ChangePasswordRequest) (*emptypb.Empty, error) {
