...
func (ar *AddressStore) GetAddressByProfileID(ctx context.Context, profileID uint32) (model.Addresses, error) {
	...
	err = ar.Db.QueryRow(ctx, query, profileID).Scan(&address.Address)
