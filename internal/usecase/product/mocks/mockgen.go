...
func (mr *MockcartManagerMockRecorder) GetCartProductCount(ctx, userID, productID interface{}) *gomock.Call {
...
func (mr *MockcartManagerMockRecorder) ProductInCart(ctx, userId, productId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockproductCardGetterMockRecorder) GetProductByID(ctx, productID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
