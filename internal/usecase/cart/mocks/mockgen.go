...
func (mr *MockpromoCodeGetterMockRecorder) GetPromoCode(ctx, userID, promoCodeName interface{}) *gomock.Call {
...
func (mr *MockcartRepositoryMockRecorder) AddProduct(ctx, productID, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockcartRepositoryMockRecorder) ChangeCartProductCount(ctx, productID, count, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockcartRepositoryMockRecorder) ChangeCartProductDeletedState(ctx, productID, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockcartRepositoryMockRecorder) ChangeCartProductSelectedState(ctx, productID, userID, isSelected interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockcartRepositoryMockRecorder) GetCartProduct(ctx, productID, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockcartRepositoryMockRecorder) GetCartProductCount(ctx, userID, productID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockcartRepositoryMockRecorder) GetSelectedCartItems(ctx, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockcartRepositoryMockRecorder) GetSelectedFromCart(ctx, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockcartRepositoryMockRecorder) RemoveCartProduct(ctx, productID, count, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockproductCountGetterMockRecorder) GetProductCount(ctx, productID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
