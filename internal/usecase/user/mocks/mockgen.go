...
func (mr *MockpromoCodesMessageProducerMockRecorder) AddPromoCode(ctx, userID, promoID interface{}) *gomock.Call {
...
func (mr *MockusersRepositoryMockRecorder) CreateUser(ctx, userModel interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockusersRepositoryMockRecorder) GetUserByEmail(ctx, userModel interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockusersRepositoryMockRecorder) GetUserByUserID(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
