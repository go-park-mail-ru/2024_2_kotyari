...
func (mr *MockprofileRepositoryMockRecorder) GetProfile(ctx, Id any) *gomock.Call {
...
func (mr *MockprofileRepositoryMockRecorder) UpdateProfile(ctx, profileID, profileModel any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockuserStoreMockRecorder) ChangePassword(ctx, userId, newPassword any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockuserStoreMockRecorder) GetUserByEmail(ctx, userModel any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockuserStoreMockRecorder) GetUserByUserID(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
