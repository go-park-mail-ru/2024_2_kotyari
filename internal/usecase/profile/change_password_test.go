	...
	var tests = []struct {
	...
	}{
		{
			...
			setupFunc: func(ctrl *gomock.Controller) *ProfilesService {
				...
				userRepo.EXPECT().ChangePassword(gomock.Any(), uint32(1), "newpassword").Return(nil)
		...
		},
		{
			...
			setupFunc: func(ctrl *gomock.Controller) *ProfilesService {
				...
				userRepo.EXPECT().ChangePassword(gomock.Any(), uint32(1), "newpassword").Return(errors.New("some error"))
