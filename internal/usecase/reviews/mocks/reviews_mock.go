...
// Source: internal/usecase/reviews/init.go
...
func (mr *MockreviewsRepoMockRecorder) AddReview(ctx, productID, userID, review interface{}) *gomock.Call {
...
func (mr *MockreviewsRepoMockRecorder) DeleteReview(ctx, productID, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockreviewsRepoMockRecorder) GetProductReviewsNoLogin(ctx, productID, sortField, sortOrder interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockreviewsRepoMockRecorder) GetProductReviewsWithLogin(ctx, productID, userID, sortField, sortOrder interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockreviewsRepoMockRecorder) GetReview(ctx, productID, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockreviewsRepoMockRecorder) UpdateReview(ctx, productID, userID, review interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockratingUpdaterMockRecorder) UpdateRating(ctx, productID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
